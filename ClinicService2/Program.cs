...
namespace ClinicService
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            /*            ѕо возможности доработать наш WEB API сервис с использованием шаблона Repository.ƒобавить 1 - 2 контроллера,
                        прот€нуть взаимодействие с Ѕƒ как мы это выполнили на примере репозитори€ ClientRepository и контроллера ClientController.*/
